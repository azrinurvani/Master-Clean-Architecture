...
import com.azrinurvani.mastercleanapparchitecture.data.data_source.dto.coin_detail_dtoO.Platforms
...
data class CoinDetailDto(
    ...
    fun toCoinDetail(): CoinDetail {
        return CoinDetail(
            ...
            pricePercentage = market_data.price_change_percentage_24h_in_currency.usd,
            lowPrice = market_data.low_24h.usd.toDouble(),
            highPrice = market_data.high_24h.usd.toDouble(),
            description = description.en,
            marketCap = market_data.market_cap.usd.toDouble()
        )
    }
}